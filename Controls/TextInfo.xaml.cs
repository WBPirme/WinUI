...
namespace OGAS.Controls
{
    public partial class TextInfo : UserControl
    {
        ...
        public static readonly DependencyProperty TextTopProperty =
            DependencyProperty.Register("TextTop", typeof(string), typeof(TextInfo), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty TextMiddleProperty =
            DependencyProperty.Register("TextMiddle", typeof(string), typeof(TextInfo), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty TextBottomProperty =
            DependencyProperty.Register("TextBottom", typeof(string), typeof(TextInfo), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty IsActiveProperty =
            DependencyProperty.Register("IsActive", typeof(bool), typeof(TextInfo), new PropertyMetadata(false));
    }
}
